...
<head>
    ...
    else if(mostrecentword.indexOf("차이나")!==-1) { window.open("https://youtu.be/kk4uddaHdDE") }
		else if(mostrecentword.indexOf("china")!==-1) { window.open("https://youtu.be/kk4uddaHdDE") }
